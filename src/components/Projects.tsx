...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      id: 5,
      title: 'Hardening Script Web',
      description: 'Sitio web interactivo para presentar mi herramienta de hardening automático de servidores Linux. Incluye documentación completa, demos y guías de implementación.',
      image: '/public/sr-haze-hardening/image.png',
      category: 'development',
      technologies: ['HTML5', 'CSS3', 'JavaScript', 'Bootstrap', 'Linux'],
      features: ['Interactive Demo', 'Documentation', 'Script Showcase', 'Implementation Guide'],
      githubUrl: 'https://github.com/ZelmarMohozzo/HARDENING-SCRIPT-WEB',
      liveUrl: 'https://sr-haze-hardening.netlify.app/#importance',
      status: 'Completado'
    },
    {
      id: 6,
